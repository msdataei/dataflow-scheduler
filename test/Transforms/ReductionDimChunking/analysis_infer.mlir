...
// CHECK-NEXT:                   ktdf.data_transfer from %[[VAL_2]]#0{{\[}}%[[DIVSI_1]], %[[CONSTANT_7]], %[[VAL_4]] * 8192, %[[CONSTANT_7]]] size [1, 1, 8192, 64] to %[[VAL_5]]#0 size [524288] : memref<2x1x32768x64xf16, "L1">, !ktdf.fifo.slot<"L1LU" -> "SFU", 524288xf16>
